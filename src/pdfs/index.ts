...
// Registrar formularios en orden definitivo F1–F6
_registry.push(F1_INFO, F2_INFO, F3_INFO, F4_INFO, F5_INFO, F6_INFO)

export { F1_INFO, F2_INFO, F3_INFO, F4_INFO, F5_INFO, F6_INFO }
